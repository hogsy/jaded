...
#ifdef JADEFUSION 
  { dJointSetBallAnchor ((dxJointBall*)_id, x, y, z); }
#else
...
public:
  ...
  void setAnchor (dReal x, dReal y, dReal z)
#ifdef JADEFUSION
  { dJointSetHingeAnchor ((dxJointHinge*)_id, x, y, z); }
#else
...
#ifdef JADEFUSION
  { dJointSetHingeAxis ((dxJointHinge*)_id, x, y, z); }
#else 
...
public:
  ...
  void set()
#ifdef JADEFUSION
	  { dJointSetFixed ((dxJointFixed*)_id); }
#else
	{ dJointSetFixed (_id); }
#endif
};
