...
void dGeomSetPositionNoDirty (dGeomID, dReal x, dReal y, dReal z);
void dGeomSetRotationNoDirty (dGeomID, const dMatrix3 R);
...
void dGeomSetCategoryBits (dGeomID, ULONG bits);
void dGeomSetCollideBits (dGeomID, ULONG bits);
...
void dGeomSphereSetRadiusNoDirty (dGeomID g, dReal radius);
