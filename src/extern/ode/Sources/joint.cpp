...
// externs
#ifdef JADEFUSION
extern void dBodyAddTorque (dBodyID, dReal fx, dReal fy, dReal fz);
extern void dBodyAddForce (dBodyID, dReal fx, dReal fy, dReal fz);
#else
...
// compute anchor 1 relative to body
static void setAnchor1 (dxJoint *j, dReal x, dReal y, dReal z, dVector3 anchor1)
{
  if (j->node[0].body) 
  {

    dReal	q[4];
	float	fOldNorm, fNewNorm;

	fOldNorm = dSqrt(anchor1[0] * anchor1[0] + anchor1[1] * anchor1[1] + anchor1[2] * anchor1[2]);
    ...
    dMULTIPLY1_331 (anchor1,j->node[0].body->R,q);
 	...
 	if(fOldNorm)
	{
		fNewNorm = dSqrt(anchor1[0] * anchor1[0] + anchor1[1] * anchor1[1] + anchor1[2] * anchor1[2]);
...
static void setAnchor2 (dxJoint *j, dReal x, dReal y, dReal z, dVector3 anchor2)
{
  if (j->node[1].body) 
  {
    dReal	q[4];
	...
	fOldNorm = dSqrt(anchor2[0] * anchor2[0] + anchor2[1] * anchor2[1] + anchor2[2] * anchor2[2]);
    ...
    dMULTIPLY1_331 (anchor2,j->node[1].body->R,q);
 	...
 	if(fOldNorm)
	{
		fNewNorm = dSqrt(anchor2[0] * anchor2[0] + anchor2[1] * anchor2[1] + anchor2[2] * anchor2[2]);
...
#ifdef JADEFUSION
extern void dJointSetBallAnchor (dxJointBall *joint, dReal x, dReal y, dReal z)
#else
extern "C" void dJointSetBallAnchor (dxJointBall *joint, dReal x, dReal y, dReal z)
#endif
{
...
#ifdef JADEFUSION
extern void dJointSetAnchor1 (dxJointBall *joint, dReal x, dReal y, dReal z)
#else
extern "C" void dJointSetAnchor1 (dxJointBall *joint, dReal x, dReal y, dReal z)
#endif
{
  dUASSERT(joint,"bad joint argument");
  setAnchor1 (joint,x,y,z,joint->anchor1);
}

#ifdef JADEFUSION
extern void dJointSetAnchor2 (dxJointBall *joint, dReal x, dReal y, dReal z)
#else
extern "C" void dJointSetAnchor2 (dxJointBall *joint, dReal x, dReal y, dReal z)
#endif
{
  dUASSERT(joint,"bad joint argument");
  setAnchor2 (joint,x,y,z,joint->anchor1);
}

#ifdef JADEFUSION
extern void dJointGetBallAnchor (dxJointBall *joint, dVector3 result)
#else
...
#ifdef JADEFUSION
extern void dJointGetBallAnchor2 (dxJointBall *joint, dVector3 result)
#else
...
#ifdef JADEFUSION
extern void dJointSetHingeAnchor (dxJointHinge *joint,
#else
...
#ifdef JADEFUSION
extern void dJointSetHingeAxis (dxJointHinge *joint,
#else
...
#ifdef JADEFUSION
extern void dJointGetHingeAnchor (dxJointHinge *joint, dVector3 result)
#else
...
#ifdef JADEFUSION
extern void dJointGetHingeAnchor2 (dxJointHinge *joint, dVector3 result)
#else
...
#ifdef JADEFUSION
extern void dJointGetHingeAxis (dxJointHinge *joint, dVector3 result)
#else
...
#ifdef JADEFUSION
extern void dJointSetHingeParam (dxJointHinge *joint,
#else
...
#ifdef JADEFUSION
extern dReal dJointGetHingeParam (dxJointHinge *joint, int parameter)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetHingeAngle (dxJointHinge *joint)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetHingeAngleRate (dxJointHinge *joint)
#else
...
#ifdef JADEFUSION
extern void dJointAddHingeTorque (dxJointHinge *joint, dReal torque)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetSliderPosition (dxJointSlider *joint)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetSliderPositionRate (dxJointSlider *joint)
#else
...
#ifdef JADEFUSION
extern void dJointSetSliderAxis (dxJointSlider *joint,
#else
...
#ifdef JADEFUSION
extern void dJointGetSliderAxis (dxJointSlider *joint, dVector3 result)
#else
...
#ifdef JADEFUSION
extern void dJointSetSliderParam (dxJointSlider *joint,
#else
...
#ifdef JADEFUSION
extern dReal dJointGetSliderParam (dxJointSlider *joint, int parameter)
#else
...
#ifdef JADEFUSION
extern void dJointAddSliderForce (dxJointSlider *joint, dReal force)
#else
...
#ifdef JADEFUSION
extern void dJointSetHinge2Anchor (dxJointHinge2 *joint,
#else
...
#ifdef JADEFUSION
extern void dJointSetHinge2Axis1 (dxJointHinge2 *joint,
#else
...
#ifdef JADEFUSION
extern void dJointSetHinge2Axis2 (dxJointHinge2 *joint,
#else
...
#ifdef JADEFUSION
extern void dJointSetHinge2Param (dxJointHinge2 *joint,
#else
...
#ifdef JADEFUSION
extern void dJointGetHinge2Anchor (dxJointHinge2 *joint, dVector3 result)
#else
...
#ifdef JADEFUSION
extern void dJointGetHinge2Anchor2 (dxJointHinge2 *joint, dVector3 result)
#else
...
#ifdef JADEFUSION
extern void dJointGetHinge2Axis1 (dxJointHinge2 *joint, dVector3 result)
#else
...
#ifdef JADEFUSION
extern void dJointGetHinge2Axis2 (dxJointHinge2 *joint, dVector3 result)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetHinge2Param (dxJointHinge2 *joint, int parameter)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetHinge2Angle1 (dxJointHinge2 *joint)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetHinge2Angle1Rate (dxJointHinge2 *joint)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetHinge2Angle2Rate (dxJointHinge2 *joint)
#else
...
#ifdef JADEFUSION
extern  void dJointAddHinge2Torques (dxJointHinge2 *joint, dReal torque1, dReal torque2)
#else
...
#ifdef JADEFUSION
extern  void dJointSetUniversalAnchor (dxJointUniversal *joint,
#else
...
#ifdef JADEFUSION
extern void dJointSetUniversalAxis1 (dxJointUniversal *joint,
#else
...
#ifdef JADEFUSION
extern void dJointSetUniversalAxis2 (dxJointUniversal *joint,
#else
...
#ifdef JADEFUSION
extern void dJointGetUniversalAnchor (dxJointUniversal *joint,
#else
...
#ifdef JADEFUSION
extern void dJointGetUniversalAnchor2 (dxJointUniversal *joint,
#else
...
#ifdef JADEFUSION
extern void dJointGetUniversalAxis1 (dxJointUniversal *joint,
#else
...
#ifdef JADEFUSION
extern void dJointGetUniversalAxis2 (dxJointUniversal *joint,
#else
...
#ifdef JADEFUSION
extern void dJointSetUniversalParam (dxJointUniversal *joint,
#else
...
#ifdef JADEFUSION
extern dReal dJointGetUniversalParam (dxJointUniversal *joint, int parameter)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetUniversalAngle1 (dxJointUniversal *joint)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetUniversalAngle2 (dxJointUniversal *joint)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetUniversalAngle1Rate (dxJointUniversal *joint)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetUniversalAngle2Rate (dxJointUniversal *joint)
#else
...
#ifdef JADEFUSION
extern void dJointAddUniversalTorques (dxJointUniversal *joint, dReal torque1, dReal torque2)
#else
...
#ifdef JADEFUSION
extern void dJointSetAMotorNumAxes (dxJointAMotor *joint, int num)
#else
...
#ifdef JADEFUSION
extern void dJointSetAMotorAxis (dxJointAMotor *joint, int anum, int rel,
#else
...
#ifdef JADEFUSION
extern void dJointSetAMotorAngle (dxJointAMotor *joint, int anum,
#else
...
#ifdef JADEFUSION
extern void dJointSetAMotorParam (dxJointAMotor *joint, int parameter,
#else
...
#ifdef JADEFUSION
extern void dJointSetAMotorMode (dxJointAMotor *joint, int mode)
#else
...
#ifdef JADEFUSION
extern int dJointGetAMotorNumAxes (dxJointAMotor *joint)
#else
...
#ifdef JADEFUSION
extern void dJointGetAMotorAxis (dxJointAMotor *joint, int anum,
#else
...
#ifdef JADEFUSION
extern int dJointGetAMotorAxisRel (dxJointAMotor *joint, int anum)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetAMotorAngle (dxJointAMotor *joint, int anum)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetAMotorAngleRate (dxJointAMotor *joint, int anum)
#else
...
#ifdef JADEFUSION
extern dReal dJointGetAMotorParam (dxJointAMotor *joint, int parameter)
#else
...
#ifdef JADEFUSION
extern int dJointGetAMotorMode (dxJointAMotor *joint)
#else
...
#ifdef JADEFUSION
extern void dJointAddAMotorTorques (dxJointAMotor *joint, dReal torque1, dReal torque2, dReal torque3)
#else
...
#ifdef JADEFUSION
void dJointSetAMotorParam (dxJoint* joint, int parameter, dReal value)
{
}

void dJointSetHingeParam (dxJoint *joint, int parameter, dReal value)
{
}

void dJointSetAMotorAxis (dxJoint *joint, int anum, int rel, dReal x, dReal y, dReal z)
{
}

void dJointSetAMotorNumAxes (dxJoint *joint, int num)
{
}

void dJointSetAMotorMode (dxJoint *joint, int mode)
{
}
#endif
...
#ifdef JADEFUSION
extern void dJointSetFixed (dxJointFixed *joint)
#else
