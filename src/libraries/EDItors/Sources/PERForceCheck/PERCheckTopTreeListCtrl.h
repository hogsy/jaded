#if !defined(AFX_PERCHECKTOPTREELISTCTRL_H__B2E827F7_4D4B_11D1_980A_004095E0DEFA__INCLUDED_)
#define AFX_PERCHECKTOPTREELISTCTRL_H__B2E827F7_4D4B_11D1_980A_004095E0DEFA__INCLUDED_
...
/////////////////////////////////////////////////////////////////////////////
// EPERCheckTop_cl_TreeListCtrl window

#define UWM_TV_CHECKBOX    WM_APP   

class EPERCheckTop_cl_View;

class EPERCheckTop_cl_TreeListCtrl :  public CTreeCtrl, public PER_CDataCtrl
{
// Construction
public:
...
public:
	EPERCheckTop_cl_View* GetPERCheckView() { return (EPERCheckTop_cl_View*)GetParent() ; } ;

	BOOL IsExpanded() { return m_bIsExpanded ; } ;
	void Expanded( BOOL bExpanded ) { m_bIsExpanded = bExpanded ; } ;

	void ScrollTwinTreeItem();
	void SelectTwinTreeItem(HTREEITEM hItem);

	void InitializeFileItemVisisble();
	void GetFileItemVisible(HTREEITEM hFolderParent, std::vector<HTREEITEM>& vTreeFileItem);
	
	void GetDirIndexVisible(HTREEITEM hFolderParent, std::vector<BIG_INDEX>& vDirIndex);
...
private:
	...
	UINT m_TreeFileItemsVisibleIndex;
	std::vector<HTREEITEM> m_vTreeFileItemsVisible;
...
public:
	...
	HTREEITEM InsertItem(LPCTSTR lpszItem, BOOL bIsEditable = FALSE, BOOL bHasCombo = FALSE, HTREEITEM hParent = TVI_ROOT, HTREEITEM hInsertAfter = TVI_LAST);
...
// Overrides
	...
	//{{AFX_VIRTUAL(EPERCheckTop_cl_TreeListCtrl)	
	//}}AFX_VIRTUAL
...
public:	
	...
	virtual ~EPERCheckTop_cl_TreeListCtrl();

	// Generated message map functions
protected:
	//{{AFX_MSG(EPERCheckTop_cl_TreeListCtrl)
...
#endif // !defined(AFX_PERCHECKTOPTREELISTCTRL_H__B2E827F7_4D4B_11D1_980A_004095E0DEFA__INCLUDED_)
