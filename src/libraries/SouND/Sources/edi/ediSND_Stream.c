/*$T ediSND_Stream.c GC 1.138 06/29/04 08:40:45 */
...
#define ediSND_Cte_NotifyNb		4
#define ediSND_Cte_StreamIdNb	(2 * SND_Cte_MaxSimultaneousStream)
#define ediSND_Cte_TimeOut		5000
...
typedef enum	ediSND_tden_EvtIdentifier_
{
	evt_Add				= 0,
	evt_Sub,
	evt_KillThread,
	...
	evt_AutostopS7,
	evt_AllActionsNb
} ediSND_tden_EvtIdentifier;

typedef struct	ediSND_tdst_SoundStream_
{
...
} ediSND_tdst_SoundStream;

typedef struct	ediSND_tdst_NotifyRef_
{
	SND_tdst_SoundBuffer	*pst_SB;
	BOOL					b_Busy;
} ediSND_tdst_NotifyRef;

typedef struct	ediSND_tdst_NotifyEventList_
{
	volatile HANDLE * volatile ah_EventList;
	volatile unsigned int	ui_EventNb;
	volatile ediSND_tdst_NotifyRef * volatile apst_RefList;
	volatile unsigned int	ui_RefListSize;
} ediSND_tdst_NotifyEventList;
...
static SND_tdst_SoundBuffer *ediSND_pst_StreamCreate(SND_tdst_TargetSpecificData *, SND_tdst_WaveData *, unsigned int);
...
static int	ediSND_i_SetupNotifications(SND_tdst_SoundBuffer *);
static void ediSND_NotifyEventAdd(SND_tdst_SoundBuffer *);
static void ediSND_NotifyEventSub(SND_tdst_SoundBuffer *);

/*$1-~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

DWORD WINAPI	__Th_ediSND_ui_StreamThread(LPVOID lpParameter);
void			__Th_ediSND_NotifyEventAdd(int);
void			__Th_ediSND_NotifyEventSub(SND_tdst_SoundBuffer *, int);
void			__Th_ediSND_StreamStop(SND_tdst_SoundBuffer *, int);
void			__Th_ediSND_StreamUpdateProgress(SND_tdst_SoundBuffer *);
...
SND_tdst_SoundBuffer * volatile ediSND_gst_RequestBuffer;
ediSND_tdst_NotifyEventList ediSND_gst_NotifyManager;
unsigned int				ediSND_gui_ThreadId;
HANDLE						ediSND_gh_ThreadHandle;

/*$1-~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

HANDLE				ediSND_ga_Event[evt_AllActionsNb];
static int			ediSND_gi_StreamId;
static char			*ediSND_pc_TempBuffer;
static char			*ediSND_pc_TempBufferBis;
...
void ediSND_StreamInitModule(void)
{
	...
	ediSND_gui_ThreadId = 0;
	ediSND_gh_ThreadHandle = NULL;
	ediSND_gst_RequestBuffer = NULL;
	ediSND_gi_StreamId = 0;

	ediSND_pc_TempBuffer = (char*)L_malloc(SND_Cte_MaxBufferSize);
	ediSND_M_Assert(ediSND_pc_TempBuffer);

	ediSND_pc_TempBufferBis = (char*)L_malloc(SND_Cte_MaxBufferSize);
	ediSND_M_Assert(ediSND_pc_TempBufferBis);

	/*$1- create events ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

	for(i = 0; i < evt_AllActionsNb; i++)
	{
		ediSND_ga_Event[i] = CreateEvent(NULL, FALSE, FALSE, NULL);
		ediSND_M_Assert(ediSND_ga_Event[i]);
	}

	/*$1- alloc event list ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

	ediSND_gst_NotifyManager.ui_RefListSize = evt_AllActionsNb;
	ediSND_gst_NotifyManager.apst_RefList = (ediSND_tdst_NotifyRef *) MEM_p_Alloc(ediSND_gst_NotifyManager.ui_RefListSize * sizeof(ediSND_tdst_NotifyRef));
	ediSND_M_Assert(ediSND_gst_NotifyManager.apst_RefList);
	L_memset
	(
		(char *) ediSND_gst_NotifyManager.apst_RefList,
		0,
		ediSND_gst_NotifyManager.ui_RefListSize * sizeof(ediSND_tdst_NotifyRef)
	);

	ediSND_gst_NotifyManager.ah_EventList = (HANDLE *) MEM_p_Alloc(ediSND_gst_NotifyManager.ui_RefListSize * 2 * sizeof(HANDLE));
	ediSND_M_Assert(ediSND_gst_NotifyManager.ah_EventList);
	L_memset((void*)ediSND_gst_NotifyManager.ah_EventList, 0, ediSND_gst_NotifyManager.ui_RefListSize * 2 * sizeof(HANDLE));

	/*$1- register special actions ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

	ediSND_gst_NotifyManager.ui_EventNb = evt_SpecialActionsNb;
	for(i = 0; i < (evt_SpecialActionsNb >> 1); i++)
	{
		ediSND_gst_NotifyManager.ah_EventList[2 * i] = ediSND_ga_Event[2 * i];
		ediSND_gst_NotifyManager.ah_EventList[2 * i + 1] = ediSND_ga_Event[2 * i + 1];
		ediSND_gst_NotifyManager.apst_RefList[i].b_Busy = TRUE;
		ediSND_gst_NotifyManager.apst_RefList[i].pst_SB = NULL;
	}

	/*$1- create the thread ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

	ediSND_gh_ThreadHandle = CreateThread(NULL, 0, __Th_ediSND_ui_StreamThread, NULL, 0, (LPDWORD)&ediSND_gui_ThreadId);
	ediSND_M_Assert(ediSND_gh_ThreadHandle);
}
...
void ediSND_StreamCloseModule(void)
{
	...
	ediSND_gst_RequestBuffer = (SND_tdst_SoundBuffer *) -1;
	SetEvent(ediSND_ga_Event[evt_KillThread]);
	WaitForSingleObject(ediSND_ga_Event[evt_ReceiveAck], ediSND_Cte_TimeOut);

	/*$1- kill thread ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

	WaitForSingleObject(ediSND_gh_ThreadHandle, ediSND_Cte_TimeOut);
	CloseHandle(ediSND_gh_ThreadHandle);
	ediSND_gh_ThreadHandle = NULL;
	ediSND_gui_ThreadId = 0;
	...
	if(ediSND_gst_NotifyManager.ah_EventList) MEM_Free((void *) ediSND_gst_NotifyManager.ah_EventList);
	ediSND_gst_NotifyManager.ah_EventList = NULL;

	if(ediSND_gst_NotifyManager.apst_RefList) MEM_Free((void *) ediSND_gst_NotifyManager.apst_RefList);
	ediSND_gst_NotifyManager.apst_RefList = NULL;

	ediSND_gst_NotifyManager.ui_EventNb = 0;
	ediSND_gst_NotifyManager.ui_RefListSize = 0;
	...
	for(i = 0; i < evt_AllActionsNb; i++)
	{
		if(ediSND_ga_Event[i]) CloseHandle(ediSND_ga_Event[i]);
		ediSND_ga_Event[i] = (HANDLE) NULL;
	}

	if(ediSND_pc_TempBuffer) L_free(ediSND_pc_TempBuffer);
	ediSND_pc_TempBuffer = NULL;

	if(ediSND_pc_TempBufferBis) L_free(ediSND_pc_TempBufferBis);
	ediSND_pc_TempBufferBis = NULL;
}
...
/*
 ...
 =======================================================================================================================
 */
void ediSND_CreateTrackSB(SND_tdst_SoundBuffer **_ppst_MonoSB, SND_tdst_SoundBuffer **_ppst_StereoSB)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~*/
...
/*
 ...
 =======================================================================================================================
 */
void ediSND_ReleaseTrackSB(SND_tdst_SoundBuffer *_pst_MonoSB, SND_tdst_SoundBuffer *_pst_StereoSB)
{
	ediSND_SB_Release(_pst_MonoSB);
	ediSND_SB_Release(_pst_StereoSB);
}
...
/*
 ...
 =======================================================================================================================
 */
static SND_tdst_SoundBuffer *ediSND_pst_StreamCreate
(
...
)
{
	...
	SND_tdst_SoundBuffer	*pst_SB;
	HRESULT					hr;
	ediSND_tdst_SoundStream *pst_SS;
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	...
	pst_SS = (ediSND_tdst_SoundStream *) MEM_p_Alloc(sizeof(ediSND_tdst_SoundStream));
	L_memset(pst_SS, 0, sizeof(ediSND_tdst_SoundStream));

	pst_SS->ui_NotifySize = SND_Cte_MaxBufferSize / _pst_WI->st_WaveFmtx.nBlockAlign / ediSND_Cte_NotifyNb;
	pst_SS->ui_NotifySize *= _pst_WI->st_WaveFmtx.nBlockAlign;
	pst_SS->ui_BufferSize = ediSND_Cte_NotifyNb * pst_SS->ui_NotifySize;
	...
	ediSND_M_Assert(ediSND_gi_StreamId < ediSND_Cte_StreamIdNb);
	pst_SS->h_NotifyRefreshEvent = (HANDLE) - 1;
	pst_SS->h_NotifyStopEvent = (HANDLE) - 1;
	pst_SS->i_StreamId = ediSND_gi_StreamId++;
...
/*
 ...
 =======================================================================================================================
 */
void ediSND_StreamRelease(SND_tdst_SoundBuffer *_pst_SB)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	ediSND_tdst_SoundStream *pst_SS;
	HRESULT					hr;
...
/*
 ...
 =======================================================================================================================
 */
void ediSND_StreamStop(SND_tdst_SoundBuffer *_pst_SB)
{
	/*~~~~~~~*/
	HRESULT hr;
	/*~~~~~~~*/
	...
	ediSND_gst_RequestBuffer = _pst_SB;
	SetEvent(ediSND_ga_Event[evt_Stop]);
	hr = WaitForSingleObject(ediSND_ga_Event[evt_ReceiveAck], ediSND_Cte_TimeOut);
	M_CheckTimeOut(hr, "ediSND_StreamStop");
}
...
/*
 ...
 =======================================================================================================================
 */
void ediSND_StreamPause(SND_tdst_SoundBuffer *_pst_SB)
{
	/*~~~~~~~~~~~~~*/
	DWORD	dwStatus;
	HRESULT hr;
...
)
{
	...
	ediSND_tdst_SoundStream *pst_SS;
	HRESULT					hr;
	extern BAS_tdst_barray	ediSND_gst_PlayingSB;
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	...
	if((_i_Flag & SND_Cul_SBC_PlayFxA) && (ediSND_AllocCoreBuffer(_pst_SB, SND_Cte_FxCoreA) < 0))
		return;
	else if((_i_Flag & SND_Cul_SBC_PlayFxB) && (ediSND_AllocCoreBuffer(_pst_SB, SND_Cte_FxCoreB) < 0))
		return;
	...
	ediSND_SB_SetFrequency(_pst_SB, _i_Freq);
	ediSND_SB_SetPan(_pst_SB, _i_Pan, 0);
	ediSND_SB_SetVolume(_pst_SB, _i_Vol);

	/*$1- go ahead ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

	hr = ediSND_i_SetupNotifications(_pst_SB);
	ediSND_M_Assert(hr == DS_OK);
...
/*
 ...
 =======================================================================================================================
 */
static int ediSND_i_SetupNotifications(SND_tdst_SoundBuffer *_pst_SB)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	int						hr;
	DSBPOSITIONNOTIFY		ast_PosNotify[ediSND_Cte_NotifyNb + 1];
	...
	/* setup notification */
	hr = IDirectSoundNotify_SetNotificationPositions(pst_SS->pst_DSN, ediSND_Cte_NotifyNb + 1, ast_PosNotify);
	ediSND_M_Assert(hr == DS_OK);
...
static void ediSND_StreamFullfillBuffer(SND_tdst_SoundBuffer *_pst_SB, int format)
{
	...
	HRESULT					hr;
	ediSND_tdst_SoundStream *p_stream;
	LONG					dwPos = 0;
	...
	ediSND_M_Assert(ui_Len1 == p_stream->ui_BufferSize);
	ediSND_M_Assert(ui_Len1);
	ediSND_M_Assert(NULL != pc_Write1);
	ediSND_M_Assert(p_stream->ui_WriteCursor < p_stream->ui_BufferSize);
	...
	if(ui_ActualBytesWritten < ui_Len1)
	{
		...
		hr = IDirectSoundBuffer8_GetCurrentPosition(_pst_SB->pst_DSB, (LPDWORD )&ui_PlayPos, NULL);
		ediSND_M_Assert(hr == DS_OK);
...
/*
 ...
 =======================================================================================================================
 */
static void ediSND_NotifyEventAdd(SND_tdst_SoundBuffer *_pst_SB)
{
	/*~~~~~~~*/
	HRESULT hr;
	/*~~~~~~~*/
	...
	/* assigns it in SB */
	_pst_SB->pst_SS->h_NotifyRefreshEvent = ediSND_ga_Event[evt_RefreshS0 + _pst_SB->pst_SS->i_StreamId];
	_pst_SB->pst_SS->h_NotifyStopEvent = ediSND_ga_Event[evt_AutostopS0 + _pst_SB->pst_SS->i_StreamId];
	ediSND_gst_RequestBuffer = _pst_SB;

	SetEvent(ediSND_ga_Event[evt_Add]);
	hr = WaitForSingleObject(ediSND_ga_Event[evt_ReceiveAck], ediSND_Cte_TimeOut);
	M_CheckTimeOut(hr, "ediSND_NotifyEventAdd");
}
...
/*
 ...
 =======================================================================================================================
 */
static void ediSND_NotifyEventSub(SND_tdst_SoundBuffer *_pst_SB)
{
	/*~~~~~~~*/
	HRESULT hr;
	/*~~~~~~~*/

	/* if(!ediSND_ga_Event[evt_ReceiveAck]) return; */
	ediSND_gst_RequestBuffer = _pst_SB;

	SetEvent(ediSND_ga_Event[evt_Sub]);
	hr = WaitForSingleObject(ediSND_ga_Event[evt_ReceiveAck], ediSND_Cte_TimeOut);
	M_CheckTimeOut(hr, "ediSND_NotifyEventSub");
}
...
)
{
    ...
    *_pui_actual_size = 0;
	pSS = _pSB->pst_SS;
	bChain = FALSE;
	pBuff = b_ThreadCall ? ediSND_pc_TempBuffer : ediSND_pc_TempBufferBis;
	...
	if ( format == WAVE_FORMAT_XBOX_ADPCM )
	{
		...
		ediSND_M_Assert(!(newsize % (36 * _pSB->i_Channel)));

		L_memset(pBuff, 0, SND_Cte_MaxBufferSize);

		ReadFile(pSS->x_File, pBuff, newsize, (LPDWORD)_pui_actual_size, NULL);
	...
	{
		ReadFile(pSS->x_File, _pc_buffer, _ui_size, (LPDWORD)_pui_actual_size, NULL);
	}
	...
	if(bChain)
	{
		...
		{
			SetFilePointer(pSS->x_File, pSS->ui_FilePosition + pSS->ui_StartOffset, (PLONG)&dwPos, FILE_BEGIN);
		}
		...
		uiChainSize = uiChainSize - _ui_size;
		{
			...
			/*~~~~~~~~~~~~~~~~~~~~~~~*/
#ifdef JADEFUSION
			hr = _pSB->pst_DSB->GetCurrentPosition((LPDWORD)&ui_PlayPos, NULL);
#else
        ...
        if(uiChainSize <= (pSS->ui_FileSize-pSS->ui_FileCurrSeek) )
		{
			...
			if ( format == WAVE_FORMAT_XBOX_ADPCM )
			{
				...
				ReadFile(pSS->x_File, pBuff, newsize, (LPDWORD)&ui_Read, NULL);
			...
			{
				ReadFile(pSS->x_File, _pc_buffer + _ui_size, uiChainSize, (LPDWORD)&ui_Read, NULL);
			}
...
/*
 ...
 =======================================================================================================================
 */
void __Th_ediSND_StreamStop(SND_tdst_SoundBuffer *pst_SB, int b_event)
{
	/*~~~~~~~*/
	HRESULT hr;
	/*~~~~~~~*/
	...
	__Th_ediSND_NotifyEventSub(pst_SB, b_event);
}
...
/*
 ...
 =======================================================================================================================
 */
void __Th_ediSND_NotifyEventAdd(int b_event)
{
	/*~~~~~~~~~~~~~~*/
	unsigned int	i;
	/*~~~~~~~~~~~~~~*/
	...
	for(i = 0; i < ediSND_gst_NotifyManager.ui_RefListSize; i++)
	{
		if(!ediSND_gst_NotifyManager.apst_RefList[i].b_Busy) break;
	}

	if(i >= ediSND_gst_NotifyManager.ui_RefListSize)
	{
		/*~~~~~*/
		int size;
		/*~~~~~*/

		size = ediSND_gst_NotifyManager.ui_RefListSize + SND_Cte_MinAllocInst;
		if(ediSND_gst_NotifyManager.ui_RefListSize)
		{
			ediSND_M_Assert(ediSND_gst_NotifyManager.ah_EventList);
			ediSND_gst_NotifyManager.apst_RefList = (ediSND_tdst_NotifyRef *) MEM_p_Realloc
				(
					(void *) ediSND_gst_NotifyManager.apst_RefList,
					size * sizeof(ediSND_tdst_NotifyRef)
				);
			ediSND_gst_NotifyManager.ah_EventList = (HANDLE *) MEM_p_Realloc
				(
					(void *) ediSND_gst_NotifyManager.apst_RefList,
		...
		{
			ediSND_M_Assert(!ediSND_gst_NotifyManager.ah_EventList);
			ediSND_gst_NotifyManager.apst_RefList = (ediSND_tdst_NotifyRef *) MEM_p_Alloc(size * sizeof(ediSND_tdst_NotifyRef));
			ediSND_gst_NotifyManager.ah_EventList = (HANDLE *) MEM_p_Alloc(2 * size * sizeof(HANDLE));
		}

		L_memset
		(
			(void *) &ediSND_gst_NotifyManager.apst_RefList[ediSND_gst_NotifyManager.ui_RefListSize],
			0,
			SND_Cte_MinAllocInst * sizeof(ediSND_tdst_NotifyRef)
		);
		L_memset
		(
			(void *) &ediSND_gst_NotifyManager.ah_EventList[2 * ediSND_gst_NotifyManager.ui_RefListSize],
			0,
			2 * SND_Cte_MinAllocInst * sizeof(ediSND_tdst_NotifyRef)
		);
		i = ediSND_gst_NotifyManager.ui_RefListSize;
		ediSND_gst_NotifyManager.ui_RefListSize += SND_Cte_MinAllocInst;
	}

	ediSND_M_Assert(ediSND_gst_NotifyManager.ui_EventNb == (2 * i));
	ediSND_gst_NotifyManager.apst_RefList[i].b_Busy = TRUE;
	ediSND_gst_NotifyManager.apst_RefList[i].pst_SB = ediSND_gst_RequestBuffer;
	ediSND_gst_NotifyManager.ah_EventList[2 * i] = ediSND_gst_RequestBuffer->pst_SS->h_NotifyRefreshEvent;
	ediSND_gst_NotifyManager.ah_EventList[2 * i + 1] = ediSND_gst_RequestBuffer->pst_SS->h_NotifyStopEvent;
	ediSND_gst_NotifyManager.ui_EventNb += 2;

	if(b_event)
	{
		SetEvent(ediSND_ga_Event[evt_ReceiveAck]);
	}
}
...
/*
 ...
 =======================================================================================================================
 */
void __Th_ediSND_NotifyEventSub(SND_tdst_SoundBuffer *pst_SB, int b_event)
{
	/*~~~~~~~~~~~~~~~~~*/
	unsigned int	i, j;
	/*~~~~~~~~~~~~~~~~~*/
	...
	{
		for(i = j = 0; i < (ediSND_gst_NotifyManager.ui_EventNb >> 1); i++)
		{
			if(ediSND_gst_NotifyManager.apst_RefList[i].pst_SB == pst_SB)
			{
				j = i + 1;
				break;
			}
		...
		if(j)
		{
			for(; j < (ediSND_gst_NotifyManager.ui_EventNb >> 1); i++, j++)
			{
				ediSND_gst_NotifyManager.apst_RefList[i].pst_SB = ediSND_gst_NotifyManager.apst_RefList[j].pst_SB;
				ediSND_gst_NotifyManager.ah_EventList[2 * i] = ediSND_gst_NotifyManager.ah_EventList[2 * j];
				ediSND_gst_NotifyManager.ah_EventList[2 * i + 1] = ediSND_gst_NotifyManager.ah_EventList[2 * j + 1];
			}

			ediSND_gst_NotifyManager.apst_RefList[i].pst_SB = NULL;
			ediSND_gst_NotifyManager.apst_RefList[i].b_Busy = FALSE;
			ediSND_gst_NotifyManager.ah_EventList[2 * i] = (HANDLE) 0;
			ediSND_gst_NotifyManager.ah_EventList[2 * i + 1] = (HANDLE) 0;
			ediSND_gst_NotifyManager.ui_EventNb -= 2;
		}
	}
...
/*
 ...
 =======================================================================================================================
 */
void __Th_ediSND_StreamUpdateProgress(SND_tdst_SoundBuffer *_pst_SB)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	unsigned int			ui_PlayPos;
	int						hr;
...
#ifdef JADEFUSION
	hr = _pst_SB->pst_DSB->GetCurrentPosition((LPDWORD)&ui_PlayPos, NULL);
#else
...
/*
 ...
 =======================================================================================================================
 */
void ediSND_StreamUpdateStatus(SND_tdst_SoundBuffer *_pst_SB)
{
	if(_pst_SB->pst_SS)
	{
...
DWORD WINAPI __Th_ediSND_ui_StreamThread(LPVOID lpParameter)
{
	...
	while(1)
	{
		hRet = WaitForMultipleObjects
			(
				ediSND_gst_NotifyManager.ui_EventNb,
				(HANDLE *) ediSND_gst_NotifyManager.ah_EventList,
				FALSE,
				INFINITE
			);
		...
		case evt_Sub:
			__Th_ediSND_NotifyEventSub(ediSND_gst_RequestBuffer, 1);
			break;

		case evt_Stop:
			if(ediSND_gst_RequestBuffer) pst_SS = ediSND_gst_RequestBuffer->pst_SS;
			__Th_ediSND_StreamStop(ediSND_gst_RequestBuffer, 1);
			break;

		default:
			ediSND_M_Assert(hRet < ediSND_gst_NotifyManager.ui_EventNb);
			pst_SB = (SND_tdst_SoundBuffer *) ediSND_gst_NotifyManager.apst_RefList[hRet >> 1].pst_SB;
			ediSND_M_Assert(pst_SB);
			pst_SS = pst_SB->pst_SS;
			ediSND_M_Assert(pst_SS);

			if(pst_SS->b_Pause == TRUE) break;

			__Th_ediSND_StreamUpdateProgress(pst_SB);

			if(pst_SS->ui_EndCursor != -1) 
			{
				hr = IDirectSoundBuffer8_GetCurrentPosition(pst_SB->pst_DSB, (LPDWORD )&ui_PlayPos, NULL);
				ediSND_M_Assert(hr == DS_OK);

				if((ui_PlayPos > pst_SS->ui_EndCursor) && !pst_SS->ui_WaitPlayLoopBack)
				{
					__Th_ediSND_StreamStop(pst_SB, 0);
					break;
				}
			}
...
/*
 ...
 =======================================================================================================================
 */
void ediSND_StreamPrefetch(unsigned int uiPos, unsigned int uiSize)
{
	/*~~*/
	int i;
	/*~~*/
...
/*
 ...
 =======================================================================================================================
 */
void ediSND_StreamPrefetchArray(unsigned int *ui, unsigned int *pp)
{
	/*~~*/
	int i;
	/*~~*/
	...
	for(i = 0; i < SND_Cte_StreamPrefetchMax; i++)
	{
		if(ui[i]) ediSND_StreamPrefetch(ui[i], pp[i]);
	}
}
...
/*
 ...
 =======================================================================================================================
 */
void ediSND_StreamFlush(unsigned int ui)
{
	/*~~*/
	int i;
	/*~~*/
...
/*
 ...
 =======================================================================================================================
 */
void ediSND_StreamGetPrefetchStatus(unsigned int *ui)
{
...
/*
 ...
 =======================================================================================================================
 */
void ediSND_StreamGetCurrPos(SND_tdst_SoundBuffer *pSB, int *_pi_Pos, int *_pi_Write)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	...
	*_pi_Pos = 0;
	...
	__Th_ediSND_StreamUpdateProgress(pSB);
