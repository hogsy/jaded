/*$T win32SND.c GC 1.138 12/21/04 08:42:44 */
...
#endif
static int	win32SND_l_InitPrimaryBuffer(SND_tdst_TargetSpecificData *);
...
BAS_tdst_barray		win32SND_gst_PlayingSB;
win32SND_tdst_Manager win32SND_gst_SoundManager;
int					win32SND_gi_DoClose = 0;
BAS_tdst_barray		win32SND_dst_CoreUser[SND_Cte_FxCoreNb];
extern BOOL			win32SND_gb_FxAlloc;
extern BOOL			win32SND_gb_NoFx;
BOOL				win32SND_gb_Duplicate = FALSE;
...
/*
 ...
 =======================================================================================================================
 */
int win32SND_l_Init(SND_tdst_TargetSpecificData *_pst_SpecificD)
{
	/*~~~~~~~*/
	HRESULT hr;
	/*~~~~~~~*/
	...
	BAS_binit(&win32SND_dst_CoreUser[SND_Cte_FxCoreA], SND_Cte_FxMaxVoiceNbByCore);
	BAS_binit(&win32SND_dst_CoreUser[SND_Cte_FxCoreB], SND_Cte_FxMaxVoiceNbByCore);
	...
	if(win32SND_gi_DoClose) win32SND_Close(SND_gst_Params.pst_SpecificD);
	...
	if(hr == DS_OK)
	{
		...
		if(!win32SND_l_InitPrimaryBuffer(_pst_SpecificD)) return 0;
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_Close(SND_tdst_TargetSpecificData *_pst_SD)
{
	win32SND_gi_DoClose = 0;
	win32SND_StreamCloseModule();

	BAS_bfree(&win32SND_gst_PlayingSB);
	BAS_bfree(&win32SND_dst_CoreUser[SND_Cte_FxCoreA]);
	BAS_bfree(&win32SND_dst_CoreUser[SND_Cte_FxCoreB]);
...
/*
 ...
 =======================================================================================================================
 */
static int win32SND_l_InitPrimaryBuffer(SND_tdst_TargetSpecificData *_pst_SpecificD)
{
	/*~~~~~~~~~~~~~~~~~~~~~~*/
	DSBUFFERDESC	dsbd;
...
/*
 ...
 =======================================================================================================================
 */
SND_tdst_SoundBuffer *win32SND_pst_SB_Create
(
...
)
{
	...
	if(LOA_gb_SpeedMode)
	{
		if(_ui_Pos)
		{
			pc_Data = L_malloc(_pst_WI->i_Size + cbSize);
	...
	else
	{
		if(_ui_Pos)
		{
			pc_Data = L_malloc(_pst_WI->i_Size);
			if(!pc_Data) return NULL;
	...
	if(!win32SND_gb_Duplicate) SND_RamRasterAdd((int) pst_SB->pst_DSB, dsbd.dwBufferBytes);
...
/*
 ...
 =======================================================================================================================
 */
SND_tdst_SoundBuffer *win32SND_SB_ReLoad
(
...
)
{
	...
	if(!win32SND_gb_Duplicate) SND_RamRastersDel((int) _pst_SB->pst_DSB);

	pst_NewSB = win32SND_pst_SB_Create(_pst_TargetSpeData, _pst_WaveData, _ui_DataPos);
	if(pst_NewSB)
	{
		win32SND_SB_Release(_pst_SB);
	}
...
#endif
		win32SND_gb_Duplicate = TRUE;
		*_ppst_DstSB = win32SND_pst_SB_Create(_pst_SpeData, &st_WaveFile, pst_Sound->pst_Wave->ul_DataPosition);
		win32SND_gb_Duplicate = FALSE;
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_SB_Release(SND_tdst_SoundBuffer *_pst_SB)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	ULONG		ul_Found;
	...
	BAS_bdeletegetval((ULONG) _pst_SB, &win32SND_gst_PlayingSB, &ul_Found);

	win32SND_FxDel(_pst_SB);

	if(_pst_SB->pst_SS)
	{
		win32SND_StreamRelease(_pst_SB);
	}
	else
	{
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_SB_SetCurrPos(SND_tdst_SoundBuffer *_pst_SB, int _i_Pos)
{
	if(!_pst_SB) return;
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_SB_Pause(SND_tdst_SoundBuffer *_pst_SB)
{
	/*~~~~~~~~~*/
	int i_status;
	/*~~~~~~~~~*/
	...
	else
	{
		...
		else
		{
			...
			ERR_X_Warning((i_status != SND_gst_Params.l_InstanceNumber), "pause failed (win32SND_SB_Pause)", NULL);
			...
			if(GetFxSB(_pst_SB) && GetFxInterface(_pst_SB))
			{
				...
				if(SND_gf_AutoVolumeOff)
					GetFxSB(_pst_SB)->pst_DSB->SetVolume(ivol);
				else
...
/*
 ...
 =======================================================================================================================
 */
int win32SND_SB_Play(SND_tdst_SoundBuffer *_pst_SB, int _i_Flag, int iFxL, int iFxR)
{
	/*~~~~~~~~~~~~~~~~~~~~*/
	HRESULT hr;
	float	fFxL, fFxR, fFx;
	...
	{
		if(win32SND_AllocCoreBuffer(_pst_SB, SND_Cte_FxCoreA) < 0) return -1;
		win32SND_FxAdd(_pst_SB, SND_Cte_FxCoreA, iFxVol);
	}
	else if(_i_Flag & SND_Cul_SBC_PlayFxB)
	{
		if(win32SND_AllocCoreBuffer(_pst_SB, SND_Cte_FxCoreB) < 0) return -1;
		win32SND_FxAdd(_pst_SB, SND_Cte_FxCoreB, iFxVol);
	}
	else
	{
		if(win32SND_AllocCoreBuffer(_pst_SB, -1) < 0) return -1;
		win32SND_FxDel(_pst_SB);
	}
	...
	if(GetFxSB(_pst_SB) && GetFxInterface(_pst_SB))
	{
		...
		if(SND_gf_AutoVolumeOff)
			GetFxSB(_pst_SB)->pst_DSB->SetVolume(ivol + _pst_SB->i_FxVol);
		else
			GetFxSB(_pst_SB)->pst_DSB->SetVolume(DSBVOLUME_MIN);
	    ...
	    hr = GetFxSB(_pst_SB)->pst_DSB->Play
			(
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_SB_Stop(SND_tdst_SoundBuffer *_pst_SB)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	ULONG		ul_Found;
	extern void BAS_bdeletegetval(ULONG, BAS_tdst_barray *, ULONG *);
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_SB_SetVolume(SND_tdst_SoundBuffer *_pst_SB, int _i_Vol)
{
	/*~~~~~~~~*/
	LONG	idx;
	/*~~~~~~~~*/
	...
	_i_Vol += win32SND_gst_SoundManager.l_GlobalVol;
	...
	if(_pst_SB->l_Volume != _i_Vol)
	{
		...
		if(GetFxSB(_pst_SB) && GetFxInterface(_pst_SB))
		{
			if(SND_gf_AutoVolumeOff)
#ifdef JADEFUSION
				GetFxSB(_pst_SB)->pst_DSB->SetVolume(_i_Vol + _pst_SB->i_FxVol);
#else
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_SB_SetFrequency(SND_tdst_SoundBuffer *_pst_SB, int _i_Freq)
{
	if(!_pst_SB) return;
	...
	if(lAbs(_pst_SB->l_Frequency - _i_Freq) >= 100)
	{
		...
		{
#ifdef JADEFUSION
			GetFxSB(_pst_SB)->pst_DSB->SetFrequency(_i_Freq);
#else
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_SB_SetPan(SND_tdst_SoundBuffer *_pst_SB, int _i_Pan, int front)
{
	/*~~~~~~~~~~~~~*/
	LONG	l_Volume;
	LONG	l_Pan;
	...
	if(SND_gst_Params.ul_RenderMode == SND_Cte_RenderMono)
	{
		...
		if(_pst_SB->l_Pan != DSBPAN_CENTER)
		{
			...
			{
 #ifdef JADEFUSION
				GetFxSB(_pst_SB)->pst_DSB->SetPan(DSBPAN_CENTER);
#else
	...
	else
	{
		...
		if(_pst_SB->l_Pan != l_Pan)
		{
			...
			{
#ifdef JADEFUSION
				GetFxSB(_pst_SB)->pst_DSB->SetPan(l_Pan);
#else
		...
		if(_pst_SB->l_Volume != l_Volume)
		{
			...
			if(GetFxSB(_pst_SB) && GetFxInterface(_pst_SB))
			{
				if(SND_gf_AutoVolumeOff)
#ifdef JADEFUSION
					GetFxSB(_pst_SB)->pst_DSB->SetVolume(l_Volume + _pst_SB->i_FxVol);
#else					
...
/*
 ...
 =======================================================================================================================
 */
int win32SND_SB_GetStatus(SND_tdst_SoundBuffer *_pst_SB, int *_pi_Status)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	int			ret;
	extern void win32SND_StreamUpdateStatus(SND_tdst_SoundBuffer *_pst_SB);
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

	if(!_pst_SB) return 0;
	ret = 0;

	if(0)//SND_gb_EdiPause)
	{
		*_pi_Status = (int) _pst_SB->ui_LastStatus;
	}
	else
	{
		if(_pst_SB->pst_SS) win32SND_StreamUpdateStatus(_pst_SB);
...
#ifdef JADEFUSION
			GetFxSB(_pst_SB)->pst_DSB->GetStatus((LPDWORD)&status);
#else
			IDirectSoundBuffer8_GetStatus(GetFxSB(_pst_SB)->pst_DSB, &status);
#endif
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_SB_GetFrequency(SND_tdst_SoundBuffer *_pst_SB, int *_pi_Freq)
{
	if(!_pst_SB) return;
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_SB_GetPan(SND_tdst_SoundBuffer *_pst_SB, int *_pi_Pan, int *_pi_front)
{
	/*~~~~~~*/
	float	f;
	/*~~~~~~*/
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_SB_GetCurrPos(SND_tdst_SoundBuffer *_pst_SB, int *_pi_Pos, int *_pi_Write)
{
	if(_pst_SB->pst_SS)
	{
		win32SND_StreamGetCurrPos(_pst_SB, _pi_Pos, _pi_Write);
	}
	else
	{
#ifdef JADEFUSION
	...
	if(_pi_Pos)
	{
		*_pi_Pos = SND_ui_SizeToSample
			(
				(unsigned short) WAVE_FORMAT_XBOX_ADPCM,//SND_gst_Params.i_EdiWaveFormat,
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_SetGlobalVol(LONG _l_Volume)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	int						i;
	SND_tdst_SoundInstance	*pst_SI;
	...
	if(win32SND_gst_SoundManager.l_GlobalVol == _l_Volume) return;
	if(_l_Volume < DSBVOLUME_MIN) _l_Volume = DSBVOLUME_MIN;
	if(_l_Volume > DSBVOLUME_MAX) _l_Volume = DSBVOLUME_MAX;

	win32SND_gst_SoundManager.l_GlobalVol = _l_Volume;
...
{
	return win32SND_gst_SoundManager.l_GlobalVol;
}
...
/*
 ...
 =======================================================================================================================
 */
int win32SND_i_ChangeRenderMode(int _i_Mode)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	int						i;
	int						l_Volume, l_Pan;
	...
	{
		if(win32SND_gst_PlayingSB.base[i].ul_Key == -1) continue;
		pSB = (SND_tdst_SoundBuffer *) win32SND_gst_PlayingSB.base[i].ul_Key;
		...
		if(pSB->l_Pan != l_Pan)
		{
			...
			{
#ifdef JADEFUSION
				GetFxSB(pSB)->pst_DSB->SetPan(l_Pan);
#else
		...
		if(pSB->l_Volume != l_Volume)
		{
			...
			if(GetFxSB(pSB) && GetFxInterface(pSB))
			{
				if(SND_gf_AutoVolumeOff)
#ifdef JADEFUSION
					GetFxSB(pSB)->pst_DSB->SetVolume(l_Volume + pSB->i_FxVol);
#else
					IDirectSoundBuffer8_SetVolume(GetFxSB(pSB)->pst_DSB, l_Volume + pSB->i_FxVol);
#endif
				else
#ifdef JADEFUSION
					GetFxSB(pSB)->pst_DSB->SetVolume(DSBVOLUME_MIN);
#else
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_CommitChange(MATH_tdst_Vector *p)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
/*
 ...
 =======================================================================================================================
 */
int win32SND_AllocCoreBuffer(SND_tdst_SoundBuffer *_pst_SB, int core)
{
	/*~~*/
	int i;
	/*~~*/
	...
	case SND_Cte_FxCoreA:
		if(win32SND_dst_CoreUser[SND_Cte_FxCoreA].num + _pst_SB->i_Channel > SND_Cte_FxMaxVoiceNbByCore)
		{
			/*
			 * ERR_X_Warning(0, "[SND] Overflow of max number of Fx buffer played by core A
			 * (play failed)", NULL);
			 */
			if(win32SND_dst_CoreUser[SND_Cte_FxCoreB].num + _pst_SB->i_Channel > SND_Cte_FxMaxVoiceNbByCore)
			{
				ERR_X_Warning(0, "[SND] No more free buffer (play failed)", NULL);
				return -1;
			}
			else
				return win32SND_AllocCoreBuffer(_pst_SB, SND_Cte_FxCoreB);
		}

		BAS_binsert((ULONG) _pst_SB, (ULONG) _pst_SB->i_Channel, &win32SND_dst_CoreUser[SND_Cte_FxCoreA]);
		break;
	...
	case SND_Cte_FxCoreB:
		if(win32SND_dst_CoreUser[SND_Cte_FxCoreB].num + _pst_SB->i_Channel > SND_Cte_FxMaxVoiceNbByCore)
		{
			...
			if(win32SND_dst_CoreUser[SND_Cte_FxCoreA].num + _pst_SB->i_Channel > SND_Cte_FxMaxVoiceNbByCore)
			{
				...
				return win32SND_AllocCoreBuffer(_pst_SB, SND_Cte_FxCoreA);
		}

		BAS_binsert((ULONG) _pst_SB, (ULONG) _pst_SB->i_Channel, &win32SND_dst_CoreUser[SND_Cte_FxCoreB]);
		break;

	default:
		core =
			(win32SND_dst_CoreUser[SND_Cte_FxCoreB].num > win32SND_dst_CoreUser[SND_Cte_FxCoreA].num)
				? SND_Cte_FxCoreA : SND_Cte_FxCoreB;

		if(win32SND_dst_CoreUser[core].num + _pst_SB->i_Channel > SND_Cte_FxMaxVoiceNbByCore) core = 1 - core;

		if(win32SND_dst_CoreUser[core].num + _pst_SB->i_Channel > SND_Cte_FxMaxVoiceNbByCore)
		{
			ERR_X_Warning(0, "[SND] No more free buffer (play failed)", NULL);
			return -1;
		}

		BAS_binsert((ULONG) _pst_SB, (ULONG) _pst_SB->i_Channel, &win32SND_dst_CoreUser[core]);
		break;
	}

	win32SND_gst_SoundManager.i_Playing = 0;
	for(i = 0; i < win32SND_dst_CoreUser[SND_Cte_FxCoreA].num; i++)
		win32SND_gst_SoundManager.i_Playing += win32SND_dst_CoreUser[SND_Cte_FxCoreA].base[i].ul_Val;

	for(i = 0; i < win32SND_dst_CoreUser[SND_Cte_FxCoreB].num; i++)
		win32SND_gst_SoundManager.i_Playing += win32SND_dst_CoreUser[SND_Cte_FxCoreB].base[i].ul_Val;

	if(win32SND_gst_SoundManager.i_Playing > win32SND_gst_SoundManager.i_PlayingMax)
		win32SND_gst_SoundManager.i_PlayingMax = win32SND_gst_SoundManager.i_Playing;
...
/*
 ...
 =======================================================================================================================
 */
void win32SND_FreeCoreBuffer(SND_tdst_SoundBuffer *_pst_SB)
{
	BAS_bdelete((ULONG) _pst_SB, &win32SND_dst_CoreUser[SND_Cte_FxCoreA]);
	BAS_bdelete((ULONG) _pst_SB, &win32SND_dst_CoreUser[SND_Cte_FxCoreB]);
	win32SND_gst_SoundManager.i_Playing = win32SND_dst_CoreUser[SND_Cte_FxCoreA].num + win32SND_dst_CoreUser[SND_Cte_FxCoreB].num;
}
