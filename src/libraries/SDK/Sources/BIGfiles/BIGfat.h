...
#define BIG_UniverseKey() BIG_GetUniverseKey()//( BIG_gst.st_ToSave.ul_UniverseKey )
...
#define BIG_FileKey( d ) BIG_ul_GetKey( d )//(BIG_gst.dst_FileTable[d].ul_Key)
...
#define BIG_ParentFile( d )     BIG_GetFileParentDir( d )//( BIG_gst.dst_FileTableExt[ d ].st_ToSave.ul_Parent )
