/*$T VERsion_Update22.cpp GC! 1.078 03/14/00 15:21:34 */
...
/*
 =======================================================================================================================
    Ajout de pst_Sound dans la structure extended.
 =======================================================================================================================
 */
void VERsion_UpdateOneFileVersion22(char *_pc_Buf, ULONG _ul_Len, char *_pz_Path, char *_pz_File)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	...
	if(ul_IdentityFlags & OBJ_C_IdentityFlag_BaseObject)
	{
		...
		if(ul_IdentityFlags & OBJ_C_IdentityFlag_AdditionalMatrix)
		{
			ul_Key = *(LONG *) pc_Cur;
			pc_Cur += 4;
			if(!(ul_IdentityFlags & OBJ_C_IdentityFlag_AddMatArePointer)) pc_Cur += ul_Key * sizeof(MATH_tdst_Matrix);
		}
	}
