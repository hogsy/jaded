...
/*
 ...
 ===================================================================================================
 */
void VERsion_UpdateOneFileVersion6(char *_pc_Buf, ULONG _ul_Len, char *_psz_Path, char *_psz_File)
{
    /*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    char            *psz_Ext, *buf;
    LONG            *pul_Buf;
    ...
    /* Update texture file */
    if(L_stricmp(psz_Ext, ".tga") == 0)
        ul_Type = 0x10000000;
    else if(L_stricmp(psz_Ext, ".bmp") == 0)
        ul_Type = 0x20000000;
    else if(L_stricmp(psz_Ext, ".jpg") == 0)
        ul_Type = 0x30000000;
    else
        ul_Type = 0;
