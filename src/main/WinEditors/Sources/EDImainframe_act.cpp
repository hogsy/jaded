...
#	endif
	...
	case EDI_ACTION_REPORTBUG:
		ShellExecute( NULL, "open", "https://github.com/hogsy/jaded/issues/new?assignees=&labels=bug&projects=&template=bug_report.md&title=%5BBUG%5D+%3Cshort-description%3E", NULL, NULL, SW_SHOWNORMAL );
		break;
	}
