 ...
 * calling Jade_jpeg_start_compress, and enough space to write the trailing EOI
 * (a few bytes) before calling Jade_jpeg_finish_compress.  Multipass compression
...
/* Emit a byte */
{
  struct Jade_jpeg_destination_mgr * dest = cinfo->dest;
 ...
 * Jade_jpeg_start_compress() and before the first Jade_jpeg_write_scanlines() call
 ...
 * Jade_jpeg_start_compress returns.
 */
...
jinit_marker_writer (j_compress_ptr cinfo)
{
  ...
  cinfo->marker = (struct Jade_jpeg_marker_writer *)
    (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, JPOOL_IMAGE,
				SIZEOF(struct Jade_jpeg_marker_writer));
