...
//       12.10.02 - Optimizing
//		 08.09.03 - TiZ: adaptation to Gx8
//		 20.10.03 - TiZ: font from resource
//
...
// Static objects
//-----------------------------------------------------------------------------
DWORD Gx8Font::m_dwFontVertexShader = 0L;
DWORD Gx8Font::m_dwFontPixelShader  = 0L;
...
//-----------------------------------------------------------------------------
HRESULT Gx8Font::Create( const CHAR* strFontResourceFileName, DWORD dwResourceOffset )
{
...
// Desc: Create the font's internal objects (texture and array of glyph info)
//-----------------------------------------------------------------------------
HRESULT Gx8Font::Create( D3DTexture* pFontTexture, VOID* pFontData )
{
...
//-----------------------------------------------------------------------------
VOID Gx8Font::SetCursorPosition( FLOAT fCursorX, FLOAT fCursorY )
{
...
//-----------------------------------------------------------------------------
VOID Gx8Font::SetScaleFactors( FLOAT fXScaleFactor, FLOAT fYScaleFactor )
{
...
//-----------------------------------------------------------------------------
VOID Gx8Font::SetSlantFactor( FLOAT fSlantFactor )
{
...
//-----------------------------------------------------------------------------
HRESULT Gx8Font::GetTextExtent( const WCHAR* strText, FLOAT* pWidth, 
...
// Desc: Get the dimensions of a text string
//-----------------------------------------------------------------------------
HRESULT Gx8Font::GetTextExtent( const WCHAR* strText, DWORD cchText, FLOAT* pWidth, 
                                FLOAT* pHeight, BOOL bFirstLineOnly ) const
{
    // Check parameters
...
//-----------------------------------------------------------------------------
FLOAT Gx8Font::GetTextWidth( const WCHAR* strText ) const
{
...
//-----------------------------------------------------------------------------
HRESULT Gx8Font::DrawText( DWORD dwColor, const WCHAR* strText, DWORD dwFlags,
...
// Desc: Draws text as textured polygons
//-----------------------------------------------------------------------------
HRESULT Gx8Font::DrawText( FLOAT fOriginX, FLOAT fOriginY, DWORD dwColor,
...
// Desc: Draws text as textured polygons
//-----------------------------------------------------------------------------
HRESULT Gx8Font::DrawTextEx( FLOAT fOriginX, FLOAT fOriginY, DWORD dwColor,
...
//-----------------------------------------------------------------------------
LPDIRECT3DTEXTURE8 Gx8Font::CreateTexture( const WCHAR* strText, 
...
void WriteString(WCHAR *pStr, float posx, float posy, DWORD color)
{
	...
	theFont.SetScaleFactors( 1.0f, 1.0f );

	theFont.DrawText( posx,posy, color, pStr); 
}
...
void WriteStringEx(WCHAR *pStr, float posx, float posy, DWORD color)
{
	...
	theFont.SetScaleFactors( 0.80f, 0.80f );

	theFont.DrawText( posx,posy, color, pStr); 
}

void GetTextExtent( WCHAR const* strText,
                    FLOAT* pWidth, 
                    FLOAT* pHeight,
                    BOOL bFirstLineOnly )
{
	theFont.GetTextExtent(strText,pWidth,pHeight,bFirstLineOnly);
}
