...
IMPLEMENT_DYNCREATE(CGridBtnCellBase, CGridCell)
    ...
    BOOL bEraseBkgnd /*=TRUE*/)
{
	...
	return DrawBtnCell( pDC, nRow, nCol, &rect, bEraseBkgnd);
}
...
{
	ProcessCtlClick(WM_RBUTTONDOWN,     // Command that invoked.  e.g. WM_LBUTTONDOWN
