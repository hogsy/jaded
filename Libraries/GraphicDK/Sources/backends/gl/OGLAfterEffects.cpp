			...
			switch ( AENum )
			{
				...
				case 5:// Zoom smooth
					...
					switch ( P1 )
					{
						...
						case 1:
							OGL_AllAfterEffects.ZSDir.x          = Pf1;
							OGL_AllAfterEffects.ZSDirIsValidated = 1;
							break;
						case 2:
							OGL_AllAfterEffects.ZSDir.y          = Pf1;
							OGL_AllAfterEffects.ZSDirIsValidated = 1;
							break;
						case 3:
							OGL_AllAfterEffects.ZSDir.z          = Pf1;
							OGL_AllAfterEffects.ZSDirIsValidated = 1;
							break;
					}
...
#define MAX_SPALSH 64
	...
	static void OGL_ZooSmoothAndCenter( float Factor, MATH_tdst_Vector *ZSDir )
	{
...
//*/
	...
	extern "C" u32 JADE_HorizontalSymetry;
#ifdef ACTIVE_EDITORS
...
#	endif
	...
	// sigh...
	extern "C" float WOR_TimeSinceLastWorldLoad;
