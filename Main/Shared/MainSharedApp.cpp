...
extern "C" void Jaded_Profiler_StartProfiling( const char *set )
{
	jaded::sys::profiler.StartProfiling( set );
}

extern "C" void Jaded_Profiler_EndProfiling( const char *set )
{
	jaded::sys::profiler.EndProfiling( set );
}
