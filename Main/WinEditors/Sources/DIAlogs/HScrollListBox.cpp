...
void CHScrollListBox::PreSubclassWindow() 
{
	...
	//		 list box, that works with strings correctly when horizontal scroll 
	//		 bar is enabled (MFC's CLictBox doesn't scroll horizontaly, even 
	//		 though the scroll bar is shown). That's what the asserts here for.
