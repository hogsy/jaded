// To be #defined in a .h file included by an .rc file before maxversion.r

#define MAXVER_INTERNALNAME "CameraMapTexture\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "CameraMapTexture.dlt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Per Pixel Camera Mapping (plugin)\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: peter.watje\0"//should  be overidden on a per-dll level
