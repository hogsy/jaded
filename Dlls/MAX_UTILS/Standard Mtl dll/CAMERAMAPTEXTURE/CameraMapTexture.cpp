...
DWORD CameraMapTexture::GetActiveTexHandle(TimeValue t, TexHandleMaker& thmaker)
{
...
void CameraMapTexture::TranslateParameters(imrShader* shader, TimeValue t, Interval& valid) {
