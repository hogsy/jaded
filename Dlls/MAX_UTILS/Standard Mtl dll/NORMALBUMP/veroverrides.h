...
#define MAXVER_INTERNALNAME "normalrender\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "normalrender.dlt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Color Bump texmap (plugin)\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "Tech:Rudy.Cazabon\0"//should  be overidden on a per-dll level
