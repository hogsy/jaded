...
class __declspec(dllexport) MixMat : public Mtl, public IReshading  {	
	public:
...
class __declspec(dllexport) MixMatClassDesc:public ClassDesc2 {
	public:
...
class __declspec(dllexport) MixMatDlgProc : public ParamMap2UserDlgProc {
