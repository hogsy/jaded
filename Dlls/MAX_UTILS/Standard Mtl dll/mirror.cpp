...
int Mirror::BuildMaps(TimeValue t, RenderMapsContext &rmc) {
	...
	if ( srp.rendType==RENDTYPE_REGION || srp.rendType==RENDTYPE_REGIONCROP || srp.rendType==RENDTYPE_BAKE_SEL_CROP ) {
	...
	if ( srp.rendType==RENDTYPE_BAKE_SEL_CROP )
		srp.rendType = RENDTYPE_REGIONCROP;
