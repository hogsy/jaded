...
public:
	...
	ExposureMaterialControl& operator=(const ExposureMaterialControl& emc) {
		mNoExposure = emc.mNoExposure;
		mInvertSelfIllum = emc.mInvertSelfIllum;
		mInvertReflect = emc.mInvertReflect;
		mInvertRefract = emc.mInvertRefract;
		return *this;
	} 
