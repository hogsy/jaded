...
void dBodySetPositionNoDirty   (dBodyID, dReal x, dReal y, dReal z);
void dBodySetRotationNoDirty   (dBodyID, const dMatrix3 R);
...
#ifdef JADEFUSION
void dJointSetBallAnchor (struct dxJointBall *joint, dReal x, dReal y, dReal z);
#else
void dJointSetBallAnchor (dJointID, dReal x, dReal y, dReal z);
#endif

void dJointSetAnchor1 (dJointID, dReal x, dReal y, dReal z);
void dJointSetAnchor2 (dJointID, dReal x, dReal y, dReal z);

#ifdef JADEFUSION
void dJointSetHingeAnchor (struct dxJointHinge *joint, dReal x, dReal y, dReal z);
void dJointSetHingeAxis (struct dxJointHinge *joint, dReal x, dReal y, dReal z);
#else
